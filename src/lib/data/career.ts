...
export const CAREER_ENTRIES: Array<TimelineEntry> = [
  {
    ...
    description:
      'As Head of Engineering, I led the technical and strategic transformation of an AI/ML-driven PoC into a commercially successful and government approved rail inspection system. I built the engineering organization from the ground up, establishing the teams, processes, and technology to enable rapid and sustainable business growth',
